...
| `websitesetting`  | `models.py`    | ![models.py](/static/pep8/websitesettingmodel.PNG)        |
...
| Blog slider    | Shows latest posts                      | Checked that posts updated     | Works as expected      | ![screenshot](/static/frontend/features/sliders.png)                                                                                                |
...
| Visitor | See most viewed / editor's choice posts  | Most viewed and editor's choice displayed  | ![screenshot](/static/frontend/features/most-viewed.png) ![screenshot](/static/frontend/features/editors-choice.png) |
...
| Admin   | CRUD posts                               | Create, edit, and remove posts successfully | ![screenshot](/static/frontend/features/create.png) ![screenshot](/static/frontend/features/edit-update-delete.png) |
...
- **Some external links not opening in a new tab**  
...
- None identified currently. All known bugs have been fixed.